...
%hold off;
set(gca, "FontSize", 16)
exportgraphics(gca,'alpha_04_v4_04_ver2.png','Resolution',300)
...
H=v4*((x(1) + (1-a)*k4)/(x(1) + k4)) - betaosc*x(3); %The derivative of p with respect to t. In this case, the differential equation depends on c and p.
