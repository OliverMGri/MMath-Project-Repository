...
set(gca, "FontSize", 16)
exportgraphics(gca,'dynamic_constant_p_035.png','Resolution',300)
...
H=0; %The derivative of p with respect to t. In this case, it equals zero.
