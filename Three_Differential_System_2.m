...
%hold off;
set(gca, "FontSize", 16)
exportgraphics(gca,'p_exponential_22.png','Resolution',300)
...
H=Tp*(ps - x(3)); %The derivative of p with respect to t. In this case, p forms an exponential curve when integrated.
